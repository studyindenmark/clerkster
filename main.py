...
routes = [
  ...
  Route('/api/facebook/pages', handler='handlers.FacebookHandler:get_pages'),
  Route('/api/facebook/pages/<page_id>', handler='handlers.FacebookHandler:get_page', methods=['GET']),
  Route('/api/facebook/pages/<page_id>', handler='handlers.FacebookHandler:post_page', methods=['POST']),
