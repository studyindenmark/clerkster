...
routes = [
  ...
  Route('/facebook/pages/<page_id>/posts/<post_id>', handler='handlers.FacebookHandler:get_post', methods=['GET']),
  Route('/facebook/pages/<page_id>/threads', handler='handlers.FacebookHandler:get_threads', methods=['GET']),
